...
<div class="container">
	<div class="row justify-content-center">
        <?php
            ...
            $withdraw_url = url('/admin/report/withdraw-report');
            $user_withdraw_url = url('/admin/report/user-withdraw-report');
        ?>
        <?php
        if ($currentURL == $withdraw_url) {
            ?>
            <div class="col-xl-6 single-filed">
                <div class="block">
                    ...
                    <div class="block-content">
                        <form action="{{route('report.withdraw')}}" method="get">
        ...
        <?php
        if ($currentURL == $user_withdraw_url) {
            ?>
            <div class="col-xl-6 single-filed">
                <div class="block">
                    <div class="block-header block-header-default">
                    ...
                    <div class="block-content">
                        <form action="{{route('report.user.withdraw')}}" method="get">
                        	<div class="form-group row">
                                <div class="col-md-12">
