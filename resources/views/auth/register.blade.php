...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Error</title>
        <link rel="shortcut icon" href="{{ asset('asset/backend_asset/assets/media/favicons/logo.png')}}">
        <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('asset/backend_asset/assets/media/favicons/logo.png')}}">
        <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('asset/backend_asset/assets/media/favicons/logo.png')}}">
        <!-- Stylesheets -->
